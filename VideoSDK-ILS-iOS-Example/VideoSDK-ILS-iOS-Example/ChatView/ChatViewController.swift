...
class ChatViewController: MessagesViewController {
    ...
    private func setupMessagesCollectionView() {
        ...
        messagesCollectionView.scrollIndicatorInsets = UIEdgeInsets(
            top: 45,
            left: 0,
            bottom: 0,
            right: 0
...
extension ChatViewController: MessagesDataSource {
    ...
    func numberOfSections(in messagesCollectionView: MessagesCollectionView)
        -> Int
    {
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    ...
    func onPubSubMessageReceived() {
        ...
        onPubsubMessagGetPrint.shared.messageUpdated = {
            ...
            guard let self = self, let pubsubMessage = pubsubMessage else {
                return
            }
